...
1.1. อัตราการเต้นของหัวใจและปริมาณออกซิเจนใน
เลือด วัดโดยใช้ Oximeter
1.2. ค่าความดันโลหิต วัดโดยใช้เครื่องวัดความดันโลหิต
1.3. ระดับความเหนื่อยสามารถกดดูระดับความ
เหนื่อยได้เพื่อประกอบการตัดสินใจ
...
1. ผู้ที่ควรห้ามหรือควรเฝ้าระวัง ได้แก่ ผู้รับการทดสอบเคยมีอาการเจ็บหน้าอกเฉียบพลันหรือแบบไม่คงที่ (unstable angina) หรือภาวะกล้ามเนื้อหัวใจตายบางส่วน (myocardial infarction) ในช่วงระยะเวลา 1 เดือนที่ผ่านมา
2. ขณะพักมีอัตราการเต้นของหัวใจมากกว่า 120 ครั้ง/นาที
3. มีความดันโลหิตช่วงหัวใจบีบตัว (systolic blood pressure) มากกว่า 180 มิลลิเมตรปรอทและความดันโลหิตช่วงหัวใจคลายตัว(diastolic blood pressure) มากกว่า 100 มิลลิเมตรปรอท
